  ...
  const PANELS = [
    ...
    },
    {
      ...
      html: `
        ...
        <ul class="help-list">
          <li><strong>鼓类</strong>：底鼓、军鼓、闭镲、开镲、通鼓、吊镲、碎音镲 — 点格开关，无音高。</li>
          <li><strong>旋律类</strong>：贝斯 / 和弦 / 领奏，以及钢琴、弦乐、木管、电吉他、管风琴、合成器等 — 点格选音高。</li>
          <li><strong>换乐器</strong>：点左侧轨名；旧工程里已删音色会自动映射到相近乐器。</li>
