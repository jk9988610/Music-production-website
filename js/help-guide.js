...
const HelpGuide = (() => {
  const PANELS = [
    ...
    },
    {
      ...
      html: `
        <h4>步进音序器</h4>
        <p>默认 7 轨，可用「+轨」「−轨」增减（1～12 轨）。<strong>点击轨名</strong>切换乐器。鼓组为两字名（底鼓、军鼓…），乐队配器为三字名（小提琴、萨克斯…）。</p>
        <ul class="help-list">
          <li><strong>鼓类</strong>：底鼓、军鼓、闭镲、开镲、通鼓、吊镲、拍手等 — 点格开关，无音高。</li>
          <li><strong>旋律类</strong>：贝斯 / 和弦 / 领奏，以及钢琴、小提琴、萨克斯、长笛、垫音、弦乐等 — 点格选音高；各音色独立合成，不按音高移调冒充。</li>
          <li><strong>换乐器</strong>：点左侧轨名；每件乐器有各自音色算法。</li>
    ...
    },
    {
      ...
      html: `
        ...
        <h4>不同调式</h4>
        <p>换「阶」为五声时，选音变少，领奏更易写「中国风」；小调时贝斯 / 和弦优先 i、iv、V 级。改调后已填音不会自动移调，需手动重选。</p>
      `,
    },
    {
      id: "mixer",
