    ...
    },
    {
      ...
      html: `
        ...
        <ul class="help-list">
          ...
          <li><strong>段落 行</strong>：「−段」「+段」减少 / 增加时间轴小节段；「复制」「剪切」「前插」「后插」编辑段落顺序与类型分配。</li>
        </ul>
        <p><strong>段落编辑：</strong>单击时间轴格子选中段落（高亮边框）；「复制」或「剪切」写入剪贴板；再选中另一格（可不选）后点「前插」或「后插」。未选中目标时，前插到开头、后插到末尾。剪切后只能粘贴一次。</p>
    ...
    },
    {
      ...
      html: `
        ...
        <ul class="help-list">
          ...
          <li><strong>密度</strong>：每轨名称旁的倍率按钮（½×～4×），弹窗选择，风格与顶栏选调相同。</li>
